...
🔒 5 private research/software repositories are documented on the repositories page.Source access may be granted upon request for research, collaboration, reproducibility, or technical review.
...
AI • Machine Learning • Deep Learning • Computer Vision • 3D LiDAR • Point Clouds • Intelligent Sensing • Telecommunications • Wireless Communications • Embedded/IoT Systems • Software Development • Teaching • Entrepreneurship

My academic path began in Information and Communication Technology Engineering, with work in LoRaWAN, wireless networks, embedded communications, and low-power receiver architectures. My research later shifted toward AI-driven 3D perception, particularly LiDAR for human monitoring, activity recognition, healthcare, urban safety, and privacy-aware sensing.

Alongside research, I have served as both a Research Assistant and Teaching Assistant, supporting engineering courses, laboratories, technical projects, and student mentoring.
...
My private repositories currently cover:

PV-RCNN + PointNet-LSTM LiDAR Activity Recognition

STG-FallNet — Spatiotemporal LiDAR Fall Detection

LiDARFall-SSL — Self-Supervised Fall Classification

Episodic Point-Cloud Activity Recognition

Predictive ADR for Mobile LoRaWAN
...
3D LiDAR → Human/ROI Extraction → Point-Cloud Processing
         → Deep Learning → Fall / Non-Fall → Evaluation
...
Elevated LiDAR → 3D Scene → Pedestrian Detection
               → Human Point-Cloud Crop → Feature Learning
...
3D detection:SECOND • PV-RCNN • OpenPCDet
...
🚶 Elevated LiDAR Human Activity Recognition — deep-learning classification of pedestrian activities from elevated LiDAR.

🌆 Smart-City 3D LiDAR Object Detection — synthetic and real-world LiDAR pipelines for traffic and pedestrian monitoring.

🛰️ LoRaWAN Data-Rate Adaptation with Machine Learning — ML-based data-rate decisions for mobile LoRaWAN devices.

🔋 Low-Power Wake-Up Receiver — receiver architecture designed to reduce unnecessary radio activity and energy use.

🧭 SAFE-NAV — pedestrian-safety navigation combining GPS and IMU measurements.

👶 LiDNEST — baby breathing monitoring concept for healthcare technology and entrepreneurship.
...
Digital Logic • Electronic Devices • Programming • Engineering Labs • Technical Assignments • Projects • Research Mentoring • Debugging

My favorite teaching moment is somewhere between:
...
👶 LiDNEST — Baby breathing monitoring system — Missouri S&T Annual Startup Challenge, 3rd Prize (2025)

🧭 SAFE-NAV — Pedestrian-safety navigation — PickHacks, 1st Place (2024)

🩺 LIVE Care — LiDAR-based concept for senior well-being and safety

🌱 PWS — Agricultural insect-expulsion IoT system — SUP'COM Entrepreneurial Challenge, 3rd Prize (2022)
...
AI / Machine LearningPyTorch • TensorFlow • Deep Learning • Machine Learning

Computer Vision & 3DOpenCV • Open3D • OpenPCDet • PointNet • SECOND • PV-RCNN • 3D Point Clouds

Data & ApplicationsNumPy • Jupyter • Streamlit • Flask • NLTK • Tkinter • PyMongo • MySQL

Simulation & SensorsBlender • 3D LiDAR • Ouster SDK • GPS • IMU

Networks & Communications5G • LTE • 4G • Wi-Fi • Bluetooth • LoRaWAN • Wireless Networks
...
Artificial Intelligence + 3D Computer Vision + LiDAR Sensing
...
<a href="https://www.linkedin.com/in/nawfal-guefrachi/">
<img src="https://img.shields.io/badge/LinkedIn-Connect-0A66C2?logo=linkedin&logoColor=white" />
</a>

<a href="https://scholar.google.com/citations?user=qNGBEkMAAAAJ&hl=fr&inst=15611845720231691803">
